...
parser.add_argument('--SummaryFile', type = str, help = 'Manually identify the project you want to analyze')

args = parser.parse_args()

fileManager = FM(projectID = args.ProjectID, summaryFile=args.SummaryFile)
